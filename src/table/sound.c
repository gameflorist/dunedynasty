...
#define ADD_MUSIC_FROM_FED2K_MT32(FILENAME)         { MUSIC_WANT,   MUSICSET_FED2K_MT32,  FED2K_MT32_PREFIX "/" FILENAME, 0, 0.65f }
#define ADD_MUSIC_FROM_D2TM_ADLIB(FILENAME,VOLUME)  { MUSIC_WANT,   MUSICSET_D2TM_ADLIB,  D2TM_ADLIB_PREFIX "/" FILENAME, 0, VOLUME }
#define ADD_MUSIC_FROM_D2TM_MT32(FILENAME)          { MUSIC_WANT,   MUSICSET_D2TM_MT32,   D2TM_MT32_PREFIX  "/" FILENAME, 0, 0.65f }
#define ADD_MUSIC_FROM_D2TM_SC55(FILENAME,VOLUME)   { MUSIC_WANT,   MUSICSET_D2TM_SC55,   D2TM_SC55_PREFIX  "/" FILENAME, 0, VOLUME }
#define ADD_MUSIC_FROM_DUNE2_SMD(FILENAME,VOLUME)   { MUSIC_WANT,   MUSICSET_DUNE2_SMD,   DUNE2_SMD_PREFIX  "/" FILENAME, 0, VOLUME }
#define ADD_MUSIC_FROM_DUNE2000(FILENAME,VOLUME)    { MUSIC_WANT,   MUSICSET_DUNE2000,    DUNE2000_PREFIX   "/" FILENAME, 0, VOLUME }
