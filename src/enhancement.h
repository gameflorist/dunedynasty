...
enum SecurityQuestionMode {
	...
	SECURITY_QUESTION_ANSWER_GIVEN,
...
extern bool enhancement_raise_unit_cap;
...
extern bool enhancement_skip_introduction;
...
extern bool enhancement_draw_selected_unit_trajectories;
