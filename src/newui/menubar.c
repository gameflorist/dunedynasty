...
MenuBar_CreateGameControls(void)
{
	 ...
	 * 64, 74   -- selected unit trajectories label, off/on.
	 *
	 * 25 -- previous.
	...
	const struct {
		...
		{ 64, 4, "Selected unit trajectories" },
	};
	...
	const struct {
		...
		{ 74, 4,  64 }, /* Selected unit trajectories. */
	};
...
MenuBar_TickGameControls(void)
{
	...
	switch (widgetID) {
		...
		case 0x8000 | 74: enhancement_draw_selected_unit_trajectories ^= 0x1; break;
